...
func (mpx *multiplexer) New() Multiplexer {
	return mpx.copy()
}

func (mpx *multiplexer) WithEnv(env ...string) Multiplexer {
	var other = mpx.copy()
	if len(env) > 0 {
...
func (mpx *multiplexer) WithLoopBack() Multiplexer {
	var other = mpx.copy()
	other.cfg.LoopBack = true
	return other
}

func (mpx *multiplexer) Client() Multiplexer {
	var other = mpx.copy()
...
func (mpx *multiplexer) Server() Multiplexer {
	var other = mpx.copy()
